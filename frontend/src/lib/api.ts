...
//     updateEmployee: (id: number, data: unknown) => api.put(`/hr/employees/${id}`, data),
//     deleteEmployee: (id: number) => api.delete(`/hr/employees/${id}`),
//     markAttendance: (data: unknown) => api.post('/hr/attendance', data),
//     getAttendance: (params?: Record<string, unknown>) => api.get('/hr/attendance', { params }),
...
//     getMonthlySalaryStatus: (params?: Record<string, unknown>) => api.get('/hr/payments/monthly-status', { params }),
//     // Time entries
//     upsertTimeEntry: (data: unknown) => api.post('/hr/time-entries', data),
//     getTimeEntries: (employeeId: number, params?: Record<string, unknown>) => api.get(`/hr/time-entries/employee/${employeeId}`, { params }),
//     deleteTimeEntry: (id: number) => api.delete(`/hr/time-entries/${id}`),
//     // Employee full profile
//     getEmployeeProfile: (id: number) => api.get(`/hr/employees/${id}/profile`),
//     // Overtime settings
//     updateOvertimeSettings: (id: number, data: unknown) => api.put(`/hr/employees/${id}/overtime-settings`, data),
// };
...
export const hrApi = {
    ...
    getMonthlySalaryStatus: (params?: Record<string, unknown>) => api.get('/hr/payments/monthly-status', { params }),
    // Time entries
    createTimeEntry: (data: unknown) => api.post('/hr/time-entries', data),
    updateTimeEntry: (id: number, data: unknown) => api.put(`/hr/time-entries/${id}`, data),
    getTimeEntries: (employeeId: number, params?: Record<string, unknown>) => api.get(`/hr/time-entries/employee/${employeeId}`, { params }),
    deleteTimeEntry: (id: number) => api.delete(`/hr/time-entries/${id}`),
    // Employee full profile
    getEmployeeProfile: (id: number) => api.get(`/hr/employees/${id}/profile`),
